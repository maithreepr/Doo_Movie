...
<body>
    ...
    <div class="container-fluid text-center my-5 pt-lg-2" style="color:whitesmoke;">
        <div class="movie-player-height">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/6ZfuNTqbHE8?si=6teHNhPU4bbjY0hd"
    ...
    <div class="container-fluid px-lg-5 my-5" style="color:whitesmoke">
        <div class="row mb-4">
            <div class="col-12 col-md-9 col-lg-10 mb-4">
                <p class="text-center text-md-start text-capitalize fs-4 m-0">Avengers Infinity War (2018)
        ...
        <div class="row">
            <div class="col-0 col-md-5 col-lg-3 d-none d-md-flex justify-content-center mb-4">
                <img src="assets/Movie_Poster.jpg" alt="" style="width: 85%; height: 100%; max-height: 390px;">
            </div>
                        ...
                        <a href="movie_player.php?movie_id=<?= $i + 1 ?>">
                            ...
                            <div class="position-absolute bottom-0 start-50 translate-middle-x text-linear-gradient"
                                ...
                                <p class="text-break text-center text-capitalize lh-sm text-overflow mt-0 mt-md-2 mt-lg-3 mb-0 px-2"
                                    style="color:whitesmoke;">Avengers: Infinity War (2018) อเวนเจอร์ส: มหาสงครามล้างจักรวาล
                                </p>
                            </div>
                        </a>
                    </div>

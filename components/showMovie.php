<div id="carouselExampleFade" class="carousel slide carousel-fade padding-top" data-bs-ride="carousel">
    <div class="carousel-inner">
        <?php for ($i = 0; $i < 2; $i++) {
            ...
            <div class="container position-absolute top-50 start-50 translate-middle py-5"
                ...
                <div class="row align-items-end" style="height: 100%;" data-aos="fade-up" data-aos-duration="1000">
                    <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7 text-center text-lg-start">
                        ...
                        <br><br>
                        <p class="d-none d-lg-block" style="color:whitesmoke;">Lorem ipsum dolor sit amet consectetur
                            adipisicing elit. Dignissimos excepturi magni laudantium corrupti laboriosam perferendis nobis
                            libero ipsam a quibusdam. Repellendus provident minima ad ipsum quis et nostrum! Voluptatum
                            sapiente quia tenetur labore praesentium aliquam amet quasi sequi pariatur ratione.</p>
                        <div>
                            <a href="movie_player.php?movie_id=<?= $i + 1 ?>" class="btn btn-danger"><i
                                    class="fa fa-play fa-lg"></i> ดูหนัง</a>
